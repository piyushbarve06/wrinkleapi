                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                Order NO: <strong> {{$data->id}} </strong>
                                                            </h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 10px;">
                                                                Pickup Date: <strong> {{$data->pickup_date}} {{$data->pickup_slot}}
                                                                </strong>
                                                            </h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: start; word-wrap: break-word; font-weight: bold; font-family: 'Montserrat',sans-serif; font-size: 10px;">
                                                                {{$services->name}} X {{$services->quantity}}
                                                            </h1>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <strong>{{$general->currencySymbol}}
                                                                    {{$services->sell_price}}</strong>
                                                                @endif

                                                                @if($services->discount <= 0) <strong>
                                                                    {{$general->currencySymbol}}
                                                                    {{$services->original_price}}</strong>
                                                                    @endif
                                                            </h1>
